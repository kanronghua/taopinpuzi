<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/view2/goods\ajax_spec_select.html";i:1490352994;}*/ ?>
<table class="table table-bordered" id="goods_spec_table1">                                
    <tr>
        <td colspan="2"><b>商品规格:</b></td>
    </tr>
    <?php if(is_array($specList) || $specList instanceof \think\Collection): if( count($specList)==0 ) : echo "" ;else: foreach($specList as $k=>$vo): ?>
    <tr>
        <td><?php echo $vo[name]; ?>:</td>
        <td>                            
            <?php if(is_array($vo[spec_item]) || $vo[spec_item] instanceof \think\Collection): if( count($vo[spec_item])==0 ) : echo "" ;else: foreach($vo[spec_item] as $k2=>$vo2): ?>                            
