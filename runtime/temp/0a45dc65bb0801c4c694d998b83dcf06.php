    ...
    <div class="sort container">
      <div class="berserk clearfix">
        ...
        function GetRTime2(){
           ...
           <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection): if( count($goodsList)==0 ) : echo "" ;else: foreach($goodsList as $k=>$v): ?>			
      ...
      <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection): if( count($goodsList)==0 ) : echo "" ;else: foreach($goodsList as $k=>$v): ?>
        <div class="berserk-item scale" id="zxmp_32268" data-fixsite="1" data-activityid="32268" isstarted="true" data-starttime="1456365600000" data-endtime="1456797599000" data-couponid="321844" data-total-count="1" data-total-page="4" data-current-page="1">
...
<!--------底部banner-开始-------------->
	<div class="layout layer">
    	<div class="cen-banne">
            <?php $pid =6;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1494684000 and end_time > 1494684000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
